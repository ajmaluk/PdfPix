  ...
  return (
    <div className={`process ${isActive ? "active" : ""}`}>
      ...
      <svg width="48" height="48" viewBox="0 0 24 24" fill="none" className="animate-spin">
        ...
        <path d="M12 2a10 10 0 0 1 10 10" stroke="#1175ef" strokeWidth="3" strokeLinecap="round" />
      </svg>
      <p className="mt-2 text-sm" style={{ color: "var(--color-text-light)" }}>Do not close your browser. Wait until your files are uploaded and processed! This might take a few minutes.</p>
    </div>
  );
}
