...
export default function HtmlToPdfPage() {
  ...
  const sidebarContent = (
    <div className="option__panel split-sidebar-panel">
      <div className="split-sidebar-panel__header">
        <div className="option__panel__title split-sidebar-panel__title text-center w-full">HTML to PDF</div>
      </div>
      ...
      <div className="option__panel__content split-sidebar-panel__content">
        <div className="split-section">
          ...
          <div className="flex items-center gap-3 rounded-xl border-2 border-[#8b5cf6] bg-[#f5f3ff] px-4 py-3">
            ...
            <div>
              <div className="text-sm font-bold text-[#6d28d9]">Document Layout</div>
              <div className="text-[10px] text-[#7c3aed] font-medium">Standard letter layout</div>
            </div>
          </div>
        </div>
        ...
        <div className="split-section">
          ...
          <div className="space-y-2">
            {["Parses text structures", "Standard letter layout boundaries", "Preserves basic paragraphs", "100% In-browser processing"].map((feature) => (
  ...
  return (
    <ToolLayout 
      toolId="html-to-pdf" 
      title="HTML to PDF" 
      subtitle="Convert HTML web pages to PDF files."
    ...
    >
      ...
      <AdSpace />
      <FileList files={files} onRemove={removeFile} onAddFiles={addFiles} accept=".html,.htm" />
